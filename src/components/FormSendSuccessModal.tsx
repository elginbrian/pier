...
const FormSendSuccessModal: React.FC<SuccessModalProps> = ({ isOpen, onClose, onLogin, autoClose = true, duration = 5000 }) => {
      ...
      <div className={`relative bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 ease-out max-w-lg w-full mx-4 ${isVisible ? "translate-y-0 opacity-100 scale-100" : "translate-y-4 opacity-0 scale-95"}`}>
        ...
        <div className="px-6 py-6 text-center">
          ...
          <div className="space-y-4">
            <p className="text-gray-800 text-sm leading-relaxed">Thank you — we have received your form. We are processing and verifying your information.</p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-left">
              <div className="flex items-start">
                ...
                <p className="text-blue-700 text-xs leading-relaxed">After receiving your account details, please log in to our website to monitor your application status.</p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-left">
              <div className="flex items-start">
                ...
                <p className="text-yellow-700 text-xs leading-relaxed">Your data is secure and used only for identity verification. We will not share it with third parties.</p>
              </div>
            </div>
