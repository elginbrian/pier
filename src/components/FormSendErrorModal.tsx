...
const FormSendErrorModal: React.FC<ErrorModalProps> = ({
  ...
  message = "Sorry, there was an error processing your form. Please try again or contact our support team.",
  errorDetails,
  autoClose = false,
  duration = 8000,
}) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className={`relative bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 ease-out max-w-lg w-full mx-4 ${isVisible ? "translate-y-0 opacity-100 scale-100" : "translate-y-4 opacity-0 scale-95"}`}>
        ...
        {/* Header */}
        <div className="px-6 py-4 text-center text-white rounded-t-xl" style={{ backgroundColor: "#dc2626" }}>
          <h4 className="text-xl font-semibold">Form Submission Failed</h4>
        </div>

        {/* Content */}
        <div className="px-6 py-6 text-center">
          <div className="mb-6">
            <Image src="/send-form-failed.png" alt="Form Failed" width={120} height={120} className="mx-auto rounded-lg" />
          </div>

          <div className="space-y-4">
            <p className="text-gray-800 text-sm leading-relaxed">Sorry, there was a problem submitting your form. This is often caused by a lost internet connection or an unsupported file format.</p>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-left">
              <div className="flex items-start">
                ...
                <p className="text-red-700 text-xs leading-relaxed">If you continue to experience issues, please contact our support team for assistance.</p>
              </div>
            </div>
