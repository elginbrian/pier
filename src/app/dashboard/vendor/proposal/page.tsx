              ...
              {activeContracts.map((contract, index) => (
                <div key={contract.id}>
                  ...
                  {index < activeContracts.length - 1 && (
                    <div style={{ borderTop: `1px solid ${colors.base[200]}` }}></div>
                  )}
                </div>
              ))}
            </div>
                ...
                <table className="min-w-full">
                  <thead>
                    <tr style={{ borderBottom: `1px solid ${colors.base[200]}` }}>
                      <th className="text-left py-3 px-4 text-sm font-medium" style={{ color: colors.base[600] }}>ID</th>
                      <th className="text-left py-3 px-4 text-sm font-medium" style={{ color: colors.base[600] }}>Nama Kontrak</th>
                      <th className="text-left py-3 px-4 text-sm font-medium" style={{ color: colors.base[600] }}>Jumlah Biaya</th>
                      <th className="text-left py-3 px-4 text-sm font-medium" style={{ color: colors.base[600] }}>Tanggal Kadaluarsa</th>
                      <th className="text-left py-3 px-4 text-sm font-medium" style={{ color: colors.base[600] }}>Tipe</th>
                      <th className="text-left py-3 px-4 text-sm font-medium" style={{ color: colors.base[600] }}>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {contractsData.map((contract, index) => (
                      ...
                      >
                        <td className="py-4 px-4 text-sm" style={{ color: colors.base[700] }}>{contract.id}</td>
                        <td className="py-4 px-4 text-sm" style={{ color: colors.base[700] }}>{contract.name}</td>
                        <td className="py-4 px-4 text-sm" style={{ color: colors.base[700] }}>{contract.amount}</td>
                        <td className="py-4 px-4 text-sm" style={{ color: colors.base[700] }}>{contract.expiry}</td>
                        <td className="py-4 px-4 text-sm" style={{ color: colors.base[700] }}>{contract.type}</td>
