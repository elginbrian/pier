      ...
      {isDeclined && (
        ...
        >
          <div className="flex items-start">
            <div className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mr-3" style={{ backgroundColor: colors.error[400] }}>
            ...
            <div className="flex-1">
              ...
              <div>
                <h4 className="text-sm font-semibold mb-3" style={{ color: colors.error[700] }}>
                  Catatan dari Pengadaan
                </h4>
                <div className="space-y-2">
                  <div className="flex items-start">
                    <div className="w-2 h-2 rounded-full mt-2 mr-3 flex-shrink-0" style={{ backgroundColor: colors.error[400] }}></div>
      ...
      {isDeclined ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-lg shadow-sm p-6" style={{ backgroundColor: "#ffffff" }}>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="p-2 rounded-lg flex items-center space-x-2" style={{ backgroundColor: colors.base[100] }}>
            ...
            <div className="rounded-lg shadow-sm p-6" style={{ backgroundColor: "#ffffff" }}>
              ...
              >
                <h3 className="font-bold text-lg mb-4" style={{ color: colors.primary[700] }}>
                  KONTRAK PENGADAAN JASA LOGISTIK
                </h3>
                <p className="text-sm mb-4" style={{ color: colors.primary[600] }}>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg" style={{ backgroundColor: "#ffffff", border: `1px solid ${colors.base[200]}` }}>
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: colors.warning[100], border: `1px solid ${colors.warning[300]}` }}>
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: colors.error[100], border: `1px solid ${colors.error[300]}` }}>
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: colors.success[100], border: `1px solid ${colors.success[300]}` }}>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                  />
                  <button className="mt-3 px-4 py-2 rounded-lg font-medium text-white text-sm" style={{ backgroundColor: colors.primary[500] }}>
                    + Tambah Komentar
                  </button>
                </div>
              </div>
            ...
            <div className="rounded-lg shadow-sm p-6" style={{ backgroundColor: "#ffffff" }}>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between py-2">
                  <div>
                    <p className="font-medium text-sm" style={{ color: colors.base[700] }}>
                      Versi 1
                    </p>
                    <p className="text-xs" style={{ color: colors.base[500] }}>
                      Proposal Awal
                    </p>
                  </div>
                  <span
            ...
            {/* Action Buttons */}
            <div className="space-y-3">
              <button className="w-full px-6 py-3 rounded-lg font-semibold text-white flex items-center justify-center" style={{ backgroundColor: colors.primary[500] }}>
              ...
              <button className="w-full px-6 py-3 rounded-lg font-semibold text-white flex items-center justify-center" style={{ backgroundColor: colors.success[500] }}>
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <polyline points="20,6 9,17 4,12" strokeWidth="2" />
                </svg>
                Setujui Draft ILCS
        ...
        <>
          ...
          <div className="space-y-6">
              ...
              <FormSection title="Informasi Umum" icon="/info.svg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField label="Nama Perusahaan" required>
                    <Input type="text" value={formData.companyName} onChange={handleInputChange("companyName")} disabled />
                  </FormField>

                  <FormField label="Kontak PIC" required>
                    <Input type="text" value={formData.contactPerson} onChange={handleInputChange("contactPerson")} disabled />
                  </FormField>

                  <FormField label="Judul Proposal" required>
                    <Input type="text" value={formData.proposalTitle} onChange={handleInputChange("proposalTitle")} disabled />
                  </FormField>

                  <FormField label="Jenis Layanan" required>
                    <Input type="text" value={formData.serviceType} onChange={handleInputChange("serviceType")} disabled />
                  </FormField>
                </div>
              </FormSection>
            </div>
              ...
              <FormSection title="Anggaran & Biaya" icon="/dollar.svg">
                <div className="space-y-6">
                  <FormField label="Nilai Kontrak (Rp)" required>
                    <Input type="number" value={formData.contractValue} disabled />
                  </FormField>
                    ...
                    >
                      <div className="mb-4">
                        <div className="w-12 h-12 mx-auto rounded-full flex items-center justify-center">
                          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke={colors.base[500]}>
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <polyline points="14,2 14,8 20,8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </div>
                      </div>
                      <p className="text-sm mb-2" style={{ color: colors.base[600] }}>
              ...
              <FormSection title="Dokumen Pendukung">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={doc.label}>
                      <label className="block text-sm font-medium mb-3" style={{ color: colors.base[700] }}>
                        {doc.label}
                      </label>
                      <div
                        className="rounded-lg p-6 text-center"
            ...
            <div className="flex flex-col items-center justify-center text-center">
              <p className="text-sm" style={{ color: colors.base[600] }}>
                Butuh bantuan?
                <a href="#" className="hover:underline ml-1" style={{ color: colors.primary[600] }}>
                  Lihat FAQ
                </a>
                atau
                <a href="#" className="hover:underline ml-1" style={{ color: colors.primary[600] }}>
