...
import ContractAlert from "@/app/dashboard/vendor/contract/alert/page";
import DeclinedContractUI from "@/app/dashboard/vendor/contract/revision/page";
import NormalContractForm from "@/components/NormalContractForm";
import ContractStartedUI from "@/app/dashboard/vendor/contract/active/page";
import ContractSignatureUI from "@/app/dashboard/vendor/contract/signature/page";
import ContractCompletedUI from "@/app/dashboard/vendor/contract/completed/page";
...
export default function ContractReviewPage() {
  ...
  const statusMapping = {
    ...
    approved: { step: 2, declined: false },
    active: { step: 3, declined: false },
