                    ...
                    <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm p-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-slate-700">
                                <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" /> Uptime 99.5% terjamin</li>
                                <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" /> Response time &lt; 4 jam</li>
                                <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" /> Penalti keterlambatan 0.1%/hari</li>
                                <li className="flex items-center"><WarningIcon className="w-5 h-5 text-yellow-500 mr-3" /> Force majeure clause perlu review</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                       ...
                       <div className="bg-white rounded-2xl shadow-sm p-6">
                            ...
                            <div className="space-y-2">
                                <button className="w-full bg-green-500 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center hover:bg-green-600 transition-colors"><CheckCircleIcon className="w-5 h-5 mr-2" /> Setujui Kontrak</button>
                                <button className="w-full bg-red-500 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center hover:bg-red-600 transition-colors"><CloseIcon className="w-5 h-5 mr-2" /> Tolak / Minta Revisi</button>
                                <button className="w-full bg-slate-500 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center hover:bg-slate-600 transition-colors"><SaveIcon className="w-5 h-5 mr-2" /> Simpan untuk Ditinjau Nanti</button>
                            </div>
                       </div>
                       ...
                       <div className="bg-white rounded-2xl shadow-sm p-6">
                            ...
                            <div className="space-y-2">
                                <button className="w-full bg-indigo-600 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center hover:bg-indigo-700 transition-colors"><SignatureIcon className="w-5 h-5 mr-2" /> Tanda Tangani Digital</button>
                                <button className="w-full bg-slate-100 text-slate-700 font-bold py-3 px-4 rounded-lg flex items-center justify-center hover:bg-slate-200 transition-colors"><DownloadIcon className="w-5 h-5 mr-2" /> Unduh untuk TT Fisik</button>
                            </div>
                       </div>
