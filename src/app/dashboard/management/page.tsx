    ...
    <DashboardContainer>
      <div className="pt-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            { title: "Total Kontrak", value: "24", icon: "/management-file.svg" },
            { title: "Kontrak Aktif", value: "8", icon: "/tick-fill.svg" },
            { title: "Pending Review", value: "5", icon: "/pending-fill.svg" },
            { title: "Akan Berakhir", value: "3", icon: "/warning-fill.svg" },
          ].map((card, idx) => (
            <DashboardCard key={idx}>
              <div className="flex items-center justify-between">
                ...
                <img src={card.icon} alt={card.title} className="w-8 h-8 rounded-lg object-contain" />
              </div>
            </DashboardCard>
          ))}
        </div>
